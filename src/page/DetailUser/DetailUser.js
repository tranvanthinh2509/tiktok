                ...
                <div className="">
                    ...
                    <div className="flex mt-5">
                        <div className="flex text-center leading-6 mr-6">
                            <span className="text-[-18] font-semibold mr-2">{userDetail.followings.length || 0}</span>
                            <span className="text-[-18] font-normal">Đang follow</span>
                        </div>
                        <div className="flex text-center leading-6 mr-6">
                            <span className="text-[-18] font-semibold mr-2">{userDetail.followers.length || 0}</span>
